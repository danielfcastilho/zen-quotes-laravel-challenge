...
export default function GetSecureQuotes({ auth, currentApiToken }) {
    const { secureQuoteService } = useApi();
    ...
    const handleClick = async () => {
        ...
        secureQuoteService.setApiToken(apiToken);

        try {
            let data = await secureQuoteService.index(forceReload);
